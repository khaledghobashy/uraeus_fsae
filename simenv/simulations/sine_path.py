...
path_data[:, 1] = 100*1e3 * np.sin(np.linspace(0, -2*np.pi, 1000))
path_data[:, 2] = np.gradient(path_data[:, 1] / (100*1e3), np.linspace(0, -2*np.pi, 1000))
...
sim.save_as_csv('results', 'sine_path_v5', 'pos')
sim.save_as_npz('results', 'sine_path_v5')
