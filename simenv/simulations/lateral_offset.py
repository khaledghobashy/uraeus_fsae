...
controller = speed_controller(50, dt)
lateral_controller = stanley_controller(path_data, 3)
...
sim.save_as_csv('results', 'lateral_offset_left_v1', 'pos')
sim.save_as_npz('results', 'lateral_offset_left_v1')
