...
AX2_config.ax1_jcr_uca_upright.flat[:] = [0, 0, 1]
AX2_config.ax1_jcr_lca_upright.flat[:] = [0, 0, 1]
AX2_config.ax1_jcr_prod_rocker.flat[:] = [0, 0, 1]
AX2_config.ax1_jcr_tie_upright.flat[:] = [0, 0, 1]
...
AX2_config.export_json('config_inputs')
