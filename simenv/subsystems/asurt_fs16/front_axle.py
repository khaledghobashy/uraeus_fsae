...
json_file = os.path.abspath('../symenv/templates/config_inputs/dwb_bellcrank_push_cfg.json')
print(json_file)
...
AX1_config.ax1_jcr_uca_upright.flat[:] = [0, 0, 1]
AX1_config.ax1_jcr_lca_upright.flat[:] = [0, 0, 1]
AX1_config.ax1_jcr_prod_rocker.flat[:] = [0, 0, 1]
AX1_config.ax1_jcr_tie_upright.flat[:] = [0, 0, 1]
...
AX1_config.export_json('config_inputs')
